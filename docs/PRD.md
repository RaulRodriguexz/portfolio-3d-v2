...
| 11 | **Globo invertido: oceano roxo, continentes cinza (D-56)** | `three/Globe.tsx`, `three/Marker.tsx`, `public/images/world-dots.png` (regerar claro) | a fazer — **pré-requisito do D-44** |
| 12 | **Modo escuro (D-44)**, nesta ordem de frentes: **D-57 → 1 → 6 → 7 → 3 → 5 → 2** | `hooks/useAmbientTint.ts`, `index.css`, `index.html`, `Header.tsx`, `three/*` | a fazer — **último. Ler D-49, D-57 e o adendo do D-44 antes da primeira linha** |
