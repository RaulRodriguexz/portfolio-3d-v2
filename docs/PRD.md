...
| **Foco e 404** | RNF-06 auditado com Tab real em 1440 e 360 px — 2 defeitos achados no `CopyEmail` e corrigidos; 0 de 23 e 0 de 25 depois. Página 404 própria, autocontida, 3,4 KB |
...
| **Contraste entre blocos** | D-52 entregue — citação de abertura no About, marca-texto atrás da ênfase (contraste medido em 6,9:1) e subtítulo em dois parágrafos; máximo real de 75 caracteres por linha |
...
| 7 | **Hierarquia na Stack e no rodapé (D-53)** | `sections/Stack.tsx`, `layout/Footer.tsx`, `data/stack.ts` | a fazer |
| 8 | Auditoria de foco (RNF-06) e página 404 própria | global, `vercel.json` ou `404.html` | ✅ feito em 05/09 |
| 9 | **Modo escuro com botão de alternância (D-44)** | `index.css`, as duas cenas 3D, `Grain`, `Thread`, `Header` | a fazer — **último; é o item que se corta se o calendário apertar. Ler a D-49 antes de escrever qualquer linha** |
