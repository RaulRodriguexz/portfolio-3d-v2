...
|---|---|---|---|
| 1 | **Globo invertido: oceano roxo, continentes cinza (D-56)** | `three/Globe.tsx`, `three/Marker.tsx`, `public/images/world-dots.png` (regerar claro) | ✅ feito em 06/09 |
| 2 | **Modo escuro (D-44)**, nesta ordem de frentes: **D-57 → 1 → 6 → 7 → 3 → 5 → 2** | `hooks/useAmbientTint.ts`, `index.css`, `index.html`, `Header.tsx`, `three/*` | a fazer — **último. Ler D-49, D-57 e o adendo do D-44 antes da primeira linha** |

**Concluídos nesta fila (05–06/09):** 10 itens, todos em produção — D-47, D-48, M-26, M-27, M-28/D-51, D-52, D-53, foco + 404, D-54 e D-55. O detalhe de cada um está em **Concluído**, acima, e no log da seção 14.
