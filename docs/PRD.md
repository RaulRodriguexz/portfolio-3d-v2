...
|---|---|---|---|
| 1 | **Modo escuro (D-44)** — **1 de 7 frentes feita.** Restantes na ordem: **1 → 6 → 7 → 3 → 5 → 2** | `index.css`, `index.html`, `Header.tsx`, `three/*` | 🔨 em andamento — ✅ frente 4 (D-57) em `d17ee23` |
