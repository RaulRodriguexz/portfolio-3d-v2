...
|---|---|---|---|
| 1 | **Modo escuro (D-44)**, nesta ordem de frentes: **D-57 → 1 → 6 → 7 → 3 → 5 → 2** | `hooks/useAmbientTint.ts`, `index.css`, `index.html`, `Header.tsx`, `three/*` | a fazer — **último item de código da v1. Ler D-49, D-57 e os dois adendos do D-44 antes da primeira linha** |
