...
|---|---|---|---|
| 1 | Pin de Dublin com haste (M-23, D-25) | `three/Globe.tsx` → extrair `three/Marker.tsx` | a fazer |
| 2 | `WordReveal`: `h1.textContent` sem espaço | `ui/WordReveal.tsx` | a fazer |
| 3 | Diagnóstico do `WORKFLOW.md` e do `ARCHITECTURE.md` | `docs/` | a fazer |
| 4 | Reveal palavra a palavra nos `h2` (M-26) | `layout/Section.tsx` | a fazer — **depende do item 2** |
| 5 | Links e botões magnéticos (M-27, promovido do BACKLOG) | CTAs do Statement, copiar e-mail, baixar CV | a fazer |
