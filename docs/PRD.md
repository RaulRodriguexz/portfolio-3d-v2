...
| 7 | **Modo escuro com botão de alternância (D-44)** | `index.css`, as duas cenas 3D, `Grain`, `Thread`, `Header` | a fazer — **último; é o item que se corta se o calendário apertar. Ler a D-49 antes de escrever qualquer linha** |
