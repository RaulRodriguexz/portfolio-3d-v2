...
| **Status** | Aprovado — **fila de código encerrada**. O que falta para lançar são **seis linhas que não são código**, listadas por inteiro no fim da §0; a única bloqueante é a revisão do inglês |
...
| 0.95 | **D-69 — o fio roxo sai do celular** (não montar abaixo de 640 px) | Claude Code | 1 sessão | a fazer |
...
| **D-21** | 03/09 | O CV revelou material para um 4º card: "B2B Websites with Geolocation" | 📦 entregue e fechada — motivo completo em `DECISOES-ARQUIVADAS.md` | Aberta |
...
| **D-26** | 03/09 | `prefers-reduced-motion` hoje desliga as cenas 3D inteiras, não só o movimento | 📦 entregue e fechada — motivo completo em `DECISOES-ARQUIVADAS.md` | Aberta |
...
| **D-43** | 05/09 | O Memoji volta ao **centro** da área de conteúdo. O experimento de alinhá-lo à borda direita foi testado e **descartado** | 📦 entregue e fechada — motivo completo em `DECISOES-ARQUIVADAS.md` | Aberta |
| **D-44** | 05/09 | **Modo escuro com botão de alternância entra na v1**, e entra por último. Reverte a exclusão da seção 6 | 📦 entregue e fechada — motivo completo em `DECISOES-ARQUIVADAS.md` | Aberta |
...
| **D-47** | 05/09 | O `WORKFLOW.md` perde o plano e vira **documento de método**. O `CLAUDE.md` deixa de apontá-lo como fonte do "próximo passo" | 📦 entregue e fechada — motivo completo em `DECISOES-ARQUIVADAS.md` | Aberta |
| **D-48** | 05/09 | O `ARCHITECTURE.md` é corrigido, e o **contrato de camadas** passa a ser documentado. O `Thread.tsx` muda de `ui/` para `layout/` | 📦 entregue e fechada — motivo completo em `DECISOES-ARQUIVADAS.md` | Aberta |
| **D-49** | 05/09 | **O contrato de camadas e o modo escuro colidem — e o D-44 é o gatilho mais provável da falha.** Antes de qualquer código de tema, releia a regra 5 do… | 📦 entregue e fechada — motivo completo em `DECISOES-ARQUIVADAS.md` | Aberta |
...
| **D-51** | 05/09 | O fio (M-25) ganha um **ponto de luz na ponta** que acompanha o traço enquanto ele se desenha — M-28. **Fecha o inventário de movimento: nada entra depois** | 📦 entregue e fechada — motivo completo em `DECISOES-ARQUIVADAS.md` | Aberta |
