...
- [ ] Nenhum cookie criado (RNF-10) — ⚠ conferido no pacote, no script e no bundle em 07/09, **antes** de o Web Analytics ser ligado no painel. Agora que ele está ligado e servindo, **refazer a leitura na aba Application** — é a única forma de fechar o RNF-10
