...
export const profile = {
  ...
  subheadline:
    'A self-taught AI and automation developer. I work where things are ambiguous and unstructured — turning messy problems into clear plans, then into systems that connect apps, models and APIs so information moves on its own. Running for companies in marketing, legal, transport and dental since 2025.',
